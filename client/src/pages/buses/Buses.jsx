      ...
      <div className="busContainer">
        ...
        <div className="busWrapper">
          ...
          <div className="busImages">
            {photos.map((photo, i) => (
              <div className="busImgWrapper" key={i}>
                <img
          ...
          <div className="busDetails">
            <div className="busDetailsTexts">
              <h1 className="busTitle">About Indigo</h1>
              <p className="busDesc">
                ...
                About 1500 IndiGo buss operate everyday across 63 domestic and 
                24 international destinations, with its hub being New Delhi’s Indira Gandhi International Airport.                 

                <br></br>

                You can make IndiGo bus booking on a destination you wish to travel to on Yatra. 
                ...
                not offer any complimentary meals on-board, though you have the provision to buy one from the airline’s in-bus menu.
              </p>
            </div>
          </div>
